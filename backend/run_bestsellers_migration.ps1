# PowerShell script to run bestsellers migration
Write-Host "Running bestsellers migration..." -ForegroundColor Cyan
...
# Execute SQL file
Get-Content bestsellers_migration.sql | docker exec -i charan_aquarium_db mysql -u root -prootpassword charan_aquarium
