      ...
      <div className="mb-8">
        ...
        {order.shippingAddress && (
          <p className="text-gray-600 mt-2 text-sm">
            <span className="font-semibold">Địa chỉ giao hàng:</span><br />
            {order.shippingAddress}
          </p>
        )}
      </div>
      ...
      <div className="flex justify-end border-t border-gray-200 pt-4">
        <div className="text-right space-y-2">
          <div className="flex justify-between w-48">
            ...
            <span className="font-medium">{order.items.reduce((sum, item) => sum + (item.offerPrice || item.price) * item.quantity, 0).toLocaleString('vi-VN')} ₫</span>
          </div>
